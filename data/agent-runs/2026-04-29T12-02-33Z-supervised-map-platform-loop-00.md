...
- Note: `/Users/abhisheksrivastava/host_strategy/AGENTS.md` and `/Users/abhisheksrivastava/host_strategy/STRATEGY.md` are not present; strategy appears split under `docs/`.

Daily operating model:
- `/Users/abhisheksrivastava/.codex/worktrees/9496/intact-mcp-server/docs/daily_agent_operating_model.md`

Map platform feedback + artifacts:
- `/Users/abhisheksrivastava/.codex/worktrees/9496/intact-mcp-server/data/user-feedback/map-platform-feedback.md`
- Tasks directory: `/Users/abhisheksrivastava/.codex/worktrees/9496/intact-mcp-server/data/map-platform-tasks/`
- Change requests directory: `/Users/abhisheksrivastava/.codex/worktrees/9496/intact-mcp-server/data/map-platform-change-requests/`
- Recent agent runs directory: `/Users/abhisheksrivastava/intact-mcp-server/data/agent-runs/` (canonical)

Repo state (observed before preflight):
