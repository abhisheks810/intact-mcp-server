...
Open artifacts (index + spot checks):
...
- Focus artifact: `/Users/abhisheksrivastava/intact-mcp-server/data/map-platform-tasks/2026-04-25-fix-route-load-failed.md`
...
- Note: multiple prior `data/agent-runs/*.md` files are present as untracked local artifacts.
